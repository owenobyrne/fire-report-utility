...
declare namespace Paths {
  ...
  namespace GetTransactionsFilteredById {
    ...
    export interface QueryParameters {
      ...
      transactionTypes?: Parameters.TransactionTypes; // varchar
    }
    namespace Responses {
      export interface $200 {
        total?: number; // int64
...
export interface OperationMethods {
  ...
  'getAccounts'(
    ...
    data?: any,
    config?: AxiosRequestConfig  
  ): OperationResponse<Paths.GetAccounts.Responses.$200 | Paths.GetAccounts.Responses.$401>
  /**
  ...
  'getAccountById'(
    ...
    data?: any,
    config?: AxiosRequestConfig  
  ): OperationResponse<Paths.GetAccountById.Responses.$200 | Paths.GetAccountById.Responses.$401>
  /**
  ...
  'bankPayRefundRequest'(
    ...
    config?: AxiosRequestConfig  
  ): OperationResponse<Paths.BankPayRefundRequest.Responses.$200 | Paths.BankPayRefundRequest.Responses.$405>
  /**
